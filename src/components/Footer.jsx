            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  Demo Store <br />
                  No,123 Freedom, Chennai, 600111 <br />
                  India
                </address>
                <a
                  href="tel:+91 8381762799 "
                  className="mt-3 d-block mb-1 text-white fs-6"
                >
                  +91 8381762799
                </a>
                <a
                  href="mailto:gangadharana01@gmail.com"
                  className="mt-2 d-block mb-0 text-white fs-6"
                >
                  gangadharana01@gmail.com
                </a>
